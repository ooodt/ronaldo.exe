...
draw_text(9188, 71, string_hash_to_newline("Oh, playing with them was such fun... almost as fun as you, " + string(global.player_name) + "."));
draw_text(13000, 341, string_hash_to_newline("There was Neymar... and Ibrahimović ... and Buffon ... and Ramos... and so many, many more."));
draw_text(17288, 156, string_hash_to_newline("It's time your soul joined theirs, " + string(global.player_name) + "."));